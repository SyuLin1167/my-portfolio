...
export default function AnotherSufferPage() {
  ...
  const downloads = {
    executable: {
      ...
      href: "/assets/AnotherSuffer/AnotherSuffer-exe.zip" as string | null,
    },
    sourceZip: {
      label: "ソースコード",
      href: "/assets/AnotherSuffer/AnotherSuffer-src.zip" as string | null,
    },
    projectFile: {
      label: "プロジェクト",
      href: "/assets/AnotherSuffer/AnotherSuffer-project.zip" as string | null,
    },
  };
            ...
            <div className="detail-item" ref={firstDetailRef}>
              ...
              <div className="feedback-bubble" ref={bubbleRef}>
                <p className="detail-text">
                  卒業に向け、これまでの自身の成長や経験も兼ねて<br />
                  今までやったことのない技術や表現に挑戦したいと思い制作した作品です。<br />
                  期間内にゲームとしての形は作れましたが、時間が足りずサウンド周りが未実装のまま提出となってしまいました。
                </p>
              </div>
              <ul className="chips">
                <li>3D</li>
