          ...
          <div className="detail-grid">
            ...
            <div className="detail-item">
              ...
              <ul className="bullet-list">
                ...
                <p>
                  <span className="improvement-before">改善前：</span>フレームレートに依存した動作となっており、環境によって挙動が異なっていた。<br />
                  <span className="improvement-after">改善後：</span>システムクロックを用いてデルタタイムを算出し、動作を安定させた。
                </p>
                <li>メニュー画面を追加して、ゲームループの管理を改善しました。</li>
                <p>
                  <span className="improvement-before">改善前：</span>ゲームの進行状況を保存・復元する仕組みがなく、ユーザー体験が損なわれていた。<br />
                  <span className="improvement-after">改善後：</span>メニュー画面を実装し、ゲームの進行状況を保存・復元できるようにした。
                </p>
                <li>敵の追従アルゴリズムを実装し、ゲームプレイの緊張感を向上させました。</li>
                <p>
                  <span className="improvement-before">改善前：</span>キャラクターの追尾機能の実装経験がなかった。<br />
                  <span className="improvement-after">改善後：</span>プレイヤーの位置を追跡して移動する敵キャラクターを実装し、ゲームプレイの緊張感を向上させた。
                </p>
              </ul>
            </div>
